...
let contact = new Contact(1, "Soma", "Shekar", "KGF", "Kolar", "Karnataka", "563123", "9087123456", "soma@email.com");
console.log(contact.toString());

let contactArray = new Array();
try{
    contact = new Contact(2,"Anil","Kumar","Abcd","Banglore","Karnataka","416012","9359923789","anil@gmail.com");
    contactArray.push(contact);
    contact = new Contact(3,"Radha","Patil","Defg","KoLhapur","Maharashtra","416022","9359915712","radha@gmail.com");
    contactArray.push(contact);
